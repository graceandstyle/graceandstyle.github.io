...
export function CartProvider(props) {
    ...
    const [orderDetails, orderDetailsDispatch] = useReducer(checkoutReducer, null);
    const [tempCart, tempCartDispatch] = useReducer(cartReducer,[]);
